// dropbox-datastores-0.1.0-b6.js
!function () {
    var t, e, r, n, i, o, s, a, u, l, h, c, p, d, f, _, y, g, m, v, w, b, S, D, E, A, x, O, U, T, C, k, I, R, P, L, N, F, z, j, B, M, X, H, V, q, J, G, W, K, $, Z, Q, Y, te, ee, re, ne, ie, oe, se = {}.hasOwnProperty, ae = [].indexOf || function (t) {
    ...
    if (x = function () {
        ...
        return t
    }(), u = "0.1.0-b6", "undefined" != typeof global && "undefined" != typeof module && "exports"in module)f = global, _ = module.require.bind(module), module.exports = x; else if ("undefined" != typeof window && "undefined" != typeof navigator)f = window, _ = null, window.Dropbox && function () {
        var t, e, r, n;
        r = window.Dropbox, n = [];
        for (t in r)se.call(r, t) && (e = r[t], n.push(x[t] = e));
        return n
    }(), window.Dropbox = x; else {
    ...
    if (x.Env = function () {
        ...
        return t.prototype.addListener = function (t) {
            ...
            var e, r, n, i, o, s;
            if (this._listeners.indexOf)r = this._listeners.indexOf(t), -1 !== r && this._listeners.splice(r, 1); else for (s = this._listeners, e = i = 0, o = s.length; o > i; e = ++i)if (n = s[e], n === t) {
        ...
        return ue(e, t), e.prototype.url = function () {
            ...
            window.addEventListener("load", function () {
                var t, e, r, n, i, o;
                if (o = window.location.href, r = JSON.stringify({_dropboxjs_oauth_info: o}), x.AuthDriver.BrowserBase.cleanupLocation(), n = window.opener, window.parent !== window.top && (n || (n = window.parent)), n) {
                    try {
        ...
        return ue(e, t), e.prototype.onMessage = c, e.prototype.sendMessage = p, e.prototype.expandUrl = function (t) {
            ...
            var i, o, s, a, u = this;
            return(null != (o = chrome.identity) ? o.launchWebAuthFlow : void 0) ? chrome.identity.launchWebAuthFlow({url: t, interactive: !0}, function (t) {
                return u.locationStateParam(t) === e ? (e = !1, n(x.Util.Oauth.queryParamsFromUrl(t))) : void 0
            }) : (null != (s = chrome.experimental) ? null != (a = s.identity) ? a.launchWebAuthFlow : void 0 : void 0) ? chrome.experimental.identity.launchWebAuthFlow({url: t, interactive: !0}, function (t) {
                return u.locationStateParam(t) === e ? (e = !1, n(x.Util.Oauth.queryParamsFromUrl(t))) : void 0
            }) : (i = {handle: null}, this.listenForMessage(e, i, n), this.openWindow(t, function (t) {
                return i.handle = t
            }))
        }, e.prototype.openWindow = function (t, e) {
            return chrome.tabs && chrome.tabs.create ? (chrome.tabs.create({url: t, active: !0, pinned: !1}, function (t) {
                return e(t)
            }), this) : this
            ...
            return window.addEventListener("load", function () {
                var t, e;
                return t = new x.AuthDriver.Chrome, e = window.location.href, window.location.hash = "", t.sendMessage({dropbox_oauth_receiver_href: e}), window.close ? window.close() : void 0
            })
        }, e
        ...
        return t.prototype.onXhr = null, t.prototype.onError = null, t.prototype.onAuthStepChange = null, t.prototype.authDriver = function (t) {
            ...
            return n = new x.Util.Xhr("POST", this.urls.signOut), n.signWithOauth(this.oauth), this.dispatchXhr(n, function (t) {
                if (t)if (t.status === x.ApiError.INVALID_TOKEN)t = null; else if (r)return e && e(t), void 0;
            ...
            var n, i;
            return e ? (n = {offset: e.offset}, e.tag && (n.upload_id = e.tag)) : n = {offset: 0}, i = new x.Util.Xhr("POST", this.urls.chunkedUpload), i.setBody(t).setParams(n).signWithOauth(this.oauth), this.dispatchXhr(i, function (t, e) {
            ...
            var i, o;
            return n || "function" != typeof r || (n = r, r = null), i = {upload_id: e.tag}, r && (r.lastVersionTag ? i.parent_rev = r.lastVersionTag : (r.parentRev || r.parent_rev) && (i.parent_rev = r.parentRev || r.parent_rev), r.noOverwrite && (i.overwrite = "false")), o = new x.Util.Xhr("POST", "" + this.urls.commitChunkedUpload + "/" + this.urlEncodePath(t)), o.setParams(i).signWithOauth(this.oauth), this.dispatchXhr(o, function (t, e) {
                return n ? n(t, x.File.Stat.parse(e)) : void 0
            })
            ...
            return r || "function" != typeof e || (r = e, e = null), i = e && (e["long"] || e.longUrl || e.downloadHack) ? {short_url: "false"} : {}, t = this.urlEncodePath(t), o = "" + this.urls.shares + "/" + t, n = !1, s = !1, e && (e.downloadHack ? (n = !0, s = !0) : e.download && (n = !0, o = "" + this.urls.media + "/" + t)), a = new x.Util.Xhr("POST", o).setParams(i).signWithOauth(this.oauth), this.dispatchXhr(a, function (t, e) {
            ...
            var n;
            return n = new x.Util.Xhr("POST", "" + this.urls.restore + "/" + this.urlEncodePath(t)), n.setParams({rev: e}).signWithOauth(this.oauth), this.dispatchXhr(n, function (t, e) {
            ...
            var i, o, s;
            return n || "function" != typeof r || (n = r, r = null), o = {query: e}, i = !1, r && (null != r.limit && (o.file_limit = r.limit), (r.removed || r.deleted) && (o.include_deleted = !0), r.httpCache && (i = !0)), s = new x.Util.Xhr("GET", "" + this.urls.search + "/" + this.urlEncodePath(t)), s.setParams(o).signWithOauth(this.oauth, i), this.dispatchXhr(s, function (t, e) {
                var r, i;
                return i = e ? function () {
                    var t, n, i;
            ...
            var r, n;
            return e || "function" != typeof t || (e = t, t = null), r = t ? t.cursorTag ? {cursor: t.cursorTag} : {cursor: t} : {}, n = new x.Util.Xhr("POST", this.urls.delta), n.setParams(r).signWithOauth(this.oauth), this.dispatchXhr(n, function (t, r) {
            ...
            var r;
            return r = new x.Util.Xhr("POST", this.urls.fileopsCreateFolder), r.setParams({root: "auto", path: this.normalizePath(t)}).signWithOauth(this.oauth), this.dispatchXhr(r, function (t, r) {
                return e ? e(t, x.File.Stat.parse(r)) : void 0
            })
        }, t.prototype.remove = function (t, e) {
            var r;
            return r = new x.Util.Xhr("POST", this.urls.fileopsDelete), r.setParams({root: "auto", path: this.normalizePath(t)}).signWithOauth(this.oauth), this.dispatchXhr(r, function (t, r) {
                return e ? e(t, x.File.Stat.parse(r)) : void 0
            })
            ...
            var n, i, o;
            return r || "function" != typeof n || (r = n, n = null), i = {root: "auto", to_path: this.normalizePath(e)}, t instanceof x.File.CopyReference ? i.from_copy_ref = t.tag : i.from_path = this.normalizePath(t), o = new x.Util.Xhr("POST", this.urls.fileopsCopy), o.setParams(i).signWithOauth(this.oauth), this.dispatchXhr(o, function (t, e) {
                return r ? r(t, x.File.Stat.parse(e)) : void 0
            })
        }, t.prototype.move = function (t, e, r) {
            var n, i;
            return r || "function" != typeof n || (r = n, n = null), i = new x.Util.Xhr("POST", this.urls.fileopsMove), i.setParams({root: "auto", from_path: this.normalizePath(t), to_path: this.normalizePath(e)}).signWithOauth(this.oauth), this.dispatchXhr(i, function (t, e) {
                return r ? r(t, x.File.Stat.parse(e)) : void 0
            })
        }, t.prototype.appInfo = function (t, e) {
            var r;
            return e || "function" != typeof t || (e = t, t = this.oauth.credentials().key), r = new x.Util.Xhr("GET", this.urls.appsInfo), r.setParams({app_key: t}), this.dispatchXhr(r, function (r, n) {
                return e(r, x.Http.AppInfo.parse(n, t))
            })
        }, t.prototype.isAppDeveloper = function (t, e, r) {
            var n;
            return"object" == typeof t && "uid"in t && (t = t.uid), r || "function" != typeof e ? "object" == typeof e && "key"in e && (e = e.key) : (r = e, e = this.oauth.credentials().key), n = new x.Util.Xhr("GET", this.urls.appsCheckDeveloper), n.setParams({app_key: e, uid: t}), this.dispatchXhr(n, function (t, e) {
                return e ? r(t, e.is_developer) : r(t)
            })
        }, t.prototype.hasOauthRedirectUri = function (t, e, r) {
            var n;
            return r || "function" != typeof e ? "object" == typeof e && "key"in e && (e = e.key) : (r = e, e = this.oauth.credentials().key), n = new x.Util.Xhr("GET", this.urls.appsCheckRedirectUri), n.setParams({app_key: e, redirect_uri: t}), this.dispatchXhr(n, function (t, e) {
        ...
        return t.prototype.recordsChanged = null, t.prototype.syncStatusChanged = null, t.int64 = function (t) {
            ...
            for (s in n)for (r = n[s], a = 0, u = r.length; u > a; a++)e = r[a], ne(s === e._tid, "tid mismatch"), t = !0, o = e._rid, this._managed_datastore.query(s, o) || (e._deleted = !0, this._record_cache.remove(s, o));
        ...
        var e;
        return te.string(t), te.check(/^[^].*[$]$/.test(t), "does not start with ^ and end with $", t), e = "does not match regex " + t, function (r, n, i, o) {
        ...
        for (te.string(t, "struct name"), te.array(e, "fields"), _ = [], f = {}, s = y = 0, g = e.length; g > y; s = ++y) {
            ...
            }(a)) : null, r = {name: c, type: d, initFn: u}, o = "undefined" != typeof Z && null !== Z ? new Z(r) : r, _.push(o), f[c] = o
        }
        ...
        for (te.string(t, "union name"), te.array(e, "variants"), n = function () {
            ...
            return o = oe.define("" + t + "." + e, i), o.prototype.tag = function () {
                ...
                var i, s, a, u, l, h, c;
                for (l = "initializer for " + t, te.array(n, "initializer", l), te.check(n.length === r.length + 1, "does not have length " + (r.length + 1), n, "initializer", l), te.check(n[0] === e, "does not have tag " + e, n, "initializer", l), i = {_tag: e}, a = h = 0, c = r.length; c > h; a = ++h)s = r[a], u = s[0], i[u] = n[a + 1];
                return new o(i)
        ...
        return r = "initializer for " + t + " (variants " + u.join(", ") + ")", n.from_array = function (e) {
            ...
            var e, r;
            for (r in l)if (e = l[r], t instanceof e)return e.Type(t), t;
        ...
        ["handle", te.string],
        ["rev", te.uint],
        ["info", te.nullable(ie.datadict), {init: null}]
        ...
        ["rev", te.nullable(te.uint), {init: null}],
        ["conflict", te.nullable(te.string), {init: null}]
    ]), R = oe.define("GetDeltasResponse", [
        ["deltas", te.nullable(te.arrayOf(A)), {init: null}],
        ["notfound", te.nullable(te.string), {init: null}]
        ...
        ["get_deltas", te.nullable(e), {init: null}],
        ["list_datastores", te.nullable(N), {init: null}]
    ]), h = function () {
        function t(t) {
        ...
        return e = function (t, e) {
            ...
            return ne(this.finalized, "package: not finalized"), new A({changes: this.changes.slice(), nonce: t, rev: e})
        ...
        return t.from_get_snapshot_resp = function (e) {
            ...
            var t, e, r, n, i, o, s, a;
            t = {}, s = this._tables;
            for (n in s)for (r = s[n], t[n] = {}, a = r.list_record_ids(), i = 0, o = a.length; o > i; i++)e = a[i], t[n][e] = ie.clone(r.get(e).get_all());
            return t
        ...
        return t.fresh_managed_datastore = function (e, r, n, i, o, s) {
            ...
            for (i = this.resolver.resolve(this.sync_state.unsynced_deltas, this.sync_state.server_deltas), n = i.rebased_deltas, t = i.affected_records, o = this.sync_state.unsynced_deltas.slice().reverse(), a = 0, c = o.length; c > a; a++)for (r = o[a], v = r.inverse_changes(), u = 0, p = v.length; p > u; u++)e = v[u], this.datastore_model.apply_change(!1, e);
            for (w = this.sync_state.server_deltas, l = 0, d = w.length; d > l; l++)for (r = w[l], b = r.changes, h = 0, f = b.length; f > h; h++)e = b[h], this.datastore_model.apply_change(!1, e);
            for (g = 0, _ = n.length; _ > g; g++)for (r = n[g], r.undo_extras = [], S = r.changes, m = 0, y = S.length; y > m; m++)e = S[m], s = this.datastore_model.apply_change(!1, e), r.undo_extras.push(s);
            ...
            return t = function () {
                ...
                if (!e.cancelled)return r = ie.clone(e.update_manager._handle_version_map), e.cancel_fn = e.update_manager.flob_client.await(r, e.update_manager._last_dslist_token, function (n, i) {
                    ...
                    if (null != i.get_deltas) {
                        ...
                        for (u in d)if (s = d[u], null != s.notfound)e.update_manager._data_queue.push({handle: u, notfound: s.notfound}), delete e.update_manager._handle_version_map[u]; else if (null != s.deltas) {
                            for (f = s.deltas, h = 0, c = f.length; c > h; h++)a = f[h], e.update_manager._data_queue.push({handle: u, delta: a});
        ...
        function t(t) {
            ...
            for (m = ["P", "D"], a = 0, c = m.length; c > a; a++)for (o = m[a], l = 0, p = e.length; p > l; l++)i = e[l], this._transforms[o][i] = f, this._transforms[i][o] = _;
        ...
        return l = function (t) {
            ...
            var n, i, o, s, u;
            return null == r && (r = null), "sum" === this.rule_name && "P" === t.tag() && "P" === e.tag() && (null == r && (r = {I: "0"}), d(r) && d(t.value) && d(e.value)) ? (o = a(r, t.value, e.value), n = i = T.from_array(["P", o]), [n, i, e.value]) : (s = this._transforms[t.tag()][e.tag()](t, e), u = function () {
                switch (e.tag()) {
                    case"P":
                        return e.value;
                    case"D":
        ...
        return t.prototype.add_resolution_rule = function (t, e, r) {
            ...
            for (y = [], w = 0, E = e.length; E > w; w++)for (h = e[w], R = h.changes, b = 0, A = R.length; A > b; b++)o = R[b], y.push(o);
            ...
            return{rebased_deltas: _, affected_records: r}
        }, t
    }(), Q = function () {
        function t() {
        ...
        if (te.is_number(t)) {
            if (null != t[ie.INT64_TAG])return ie.validateInt64(t), {I: t[ie.INT64_TAG]};
            if (isFinite(t))return t;
            if (isNaN(t))return{N: "nan"};
            if (1 / 0 === Number(t))return{N: "+inf"};
            if (Number(t) === -1 / 0)return{N: "-inf"};
        ...
        if (te.is_date(t))return r = Math.round(t.getTime()), {T: "" + r};
        if (te.isUint8Array(t))return{B: ie.base64StringFromUint8Array(t)};
        throw new Error("Unexpected object: " + JSON.stringify(t))
        ...
        return t.prototype.get = function (t) {
            ...
            var e, r;
            if (this._checkNotDeleted(), r = this._rawFieldValues(), null == r[t])e = {}, e[t] = ["LC"], this._storeUpdate(e), r = this._rawFieldValues(); else if (!te.is_array(r[t]))throw new Error("Can't call getOrCreateList on field " + t + " for record (" + this.tid + ", " + this.rid + "): existing value " + r[t] + " is not a list");
        ...
        return e = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", r = function (t, r, n) {
            ...
            var n, i, o, s, a, u, l;
            for (a = [], n = 0, o = 0, s = u = 0, l = r.length; (l >= 0 ? l > u : u > l) && (i = r.charAt(s), "=" !== i); s = l >= 0 ? ++u : --u)n = n << 6 | e.indexOf(i), o += 1, 4 === o && (t(n, o, a), n = o = 0);
        ...
        return t.prototype.setCredentials = function (t) {
            ...
            var n, i;
            return n = {kid: this._tokenKid, ts: x.Util.Oauth.timestamp()}, i = t.toUpperCase() + "&" + x.Util.Xhr.urlEncodeValue(e) + "&" + x.Util.Xhr.urlEncodeValue(x.Util.Xhr.urlEncode(r)), n.mac = x.Util.hmac(i, this._tokenKey), n
        }, t.prototype.appHash = function () {
        ...
        var t, e;
        return e = /^\w+\, (\d+) (\w+) (\d+) (\d+)\:(\d+)\:(\d+) (\+\d+|UTC|GMT)$/, t = {Jan: 0, Feb: 1, Mar: 2, Apr: 3, May: 4, Jun: 5, Jul: 6, Aug: 7, Sep: 8, Oct: 9, Nov: 10, Dec: 11}, x.Util.parseDate = function (r) {
            var n;
        ...
        y === Object && (b = !1)
    } else S = !1, b = !0; else y = null, S = !1, b = !1;
    x.Util.Xhr = function () {
        function t(t, e) {
        ...
        return t.Request = w, t.ieXdr = v, t.canSendForms = g, t.doesPreflight = m, t.ArrayBufferView = y, t.sendArrayBufferView = b, t.wrapBlob = S, t.prototype.xhr = null, t.prototype.onError = null, t.prototype.setParams = function (t) {
            ...
            var t, e, r;
            if (this.completed)return!0;
            if (this.completed = !0, r = this.xhr.responseText, t = this.wantHeaders ? {"content-type": this.xhr.contentType} : void 0, e = void 0, this.responseType)return this.callback(null, r, e, t), !0;
    ...
    }(), re = "X-Dropbox-User-Agent", J = "X-Dropbox-Request-Id", x.DatastoresClient = {_dispatchDatastoreXhr: function (t, e, r, n, i, o) {
        var s, a, l;
        ...
        return this._dispatchDatastoreXhr("POST", this.urls.getOrCreateDb, {dsid: t}, s, {}, e)
    }, _createDatastore: function (t, e, r) {
        return this._dispatchDatastoreXhr("POST", this.urls.createDb, {dsid: t, key: e}, s, {}, r)
    }, _getDatastore: function (t, e) {
        return this._dispatchDatastoreXhr("GET", this.urls.getDb, {dsid: t}, I, {}, e)
    }, _deleteDatastore: function (t, e) {
        return this._dispatchDatastoreXhr("POST", this.urls.deleteDb, {handle: t}, E, {setRequestId: !0}, e)
    }, _putDelta: function (t, e, r) {
        return this._dispatchDatastoreXhr("POST", this.urls.putDelta, {handle: t, rev: e.rev, nonce: e.nonce, changes: JSON.stringify(e.changes)}, q, {setRequestId: !0}, r)
    }, _getSnapshot: function (t, e) {
        return this._dispatchDatastoreXhr("GET", this.urls.getSnapshot, {handle: t}, P, {}, e)
    }, _datastoreAwait: function (e, r, n) {
        return this._dispatchDatastoreXhr("GET", this.urls.datastoreAwait, {get_deltas: JSON.stringify({cursors: e}), list_datastores: JSON.stringify({token: r})}, t, {isLongPoll: !0}, n)
